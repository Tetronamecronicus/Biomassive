...
const ARRAY_HIGHP float TimeScale =  0.5;
const ARRAY_HIGHP float DistortionScale =  0.01;
uniform sampler2D SCREEN_TEXTURE;
uniform ARRAY_HIGHP float boozePower =  1;
uniform ARRAY_HIGHP float BLUR_AMOUNT =  3;
...
void main()
{
 ...
 col = col ;
 COLOR = texture ( glStencilFunc ( 1 ) , UV ) ;
